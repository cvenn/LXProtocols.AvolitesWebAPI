...
namespace LXProtocols.AvolitesWebAPI
{
    ...
    public class Selection
    {
        ...
        public async Task SelectFixtureFromHandle(HandleReference handle) {
            await http.GetAsync($"titan/script/2/Selection/Context/Programmer/SelectFixture?{handle.ToQueryArgument("handle")}");
        }
